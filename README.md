...
In each room you can find items, like attack item sword in Dungean with it's description and effect power. Use in game commands to interact with game objects.
...
Here you can take the sword using take command. Your stats will be shown after taking the item.
